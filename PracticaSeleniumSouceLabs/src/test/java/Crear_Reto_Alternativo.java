...
public class Crear_Reto_Alternativo {
...
public void acceder_CrearReto(){
	...
	driver.get("http://gamebattles.majorleaguegaming.com/xboxone/titanfall/team/baracampeon" + "/");
...
public void VisualizarReto(){
  ...
  @Test
  public void testCrearReto_Alternativo() throws Exception {	  
