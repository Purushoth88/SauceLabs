...
public class Crear_Clan_Alternativo {
...
public void acceder_CrearClan(){
    ...
    driver.findElement(By.linkText("Join the Titanfall Doubles Ladder")).click();
...
public void crearClan(){
    ...
    //driver.findElement(By.id("name")).sendKeys("Barçacampeon");
  ...
  @Test
  public void testCrearClan_Alternativo() throws Exception {
